...
cg = HurriyetGenerator()
cg.execute("hurriyet",2017,2018,1)
#cg.execute("sabah",2006,2006,1)
#cg.execute("sabah",2007,2007,1)
#cg.execute("sabah",2008,2008,1)
#cg.execute("sabah",2009,2009,1)
#cg.execute("sabah",2010,2010,1)
#cg.execute("hurriyet",2016,2016,1)
#cg.execute("hurriyet",2017,2017,1)
# cg = WiredGenerator()
# cg.execute("wired",1,20000,3)
#
#cg = CumhuriyetGenerator()
#cg.execute("cumhuriyet",1,36500,200)
#
#cg = YenisafakGenerator()
#cg.execute("yenisafak",1,2000,1)

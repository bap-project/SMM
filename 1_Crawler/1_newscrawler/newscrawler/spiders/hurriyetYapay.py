...
class HurriyetSpider(CrawlSpider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.start_urls = ["http://www.hurriyet.com.tr/arama/#/?page=%s&key=yapay%20zeka&where=/&how=Article,NewsVideo,NewsPhotoGallery,Column,Recipe&platform=/&isDetail=false" % d for d in range(1,229)]
